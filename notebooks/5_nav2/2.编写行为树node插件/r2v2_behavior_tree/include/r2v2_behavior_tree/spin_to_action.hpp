...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SPIN_TO_ACTION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SPIN_TO_ACTION_HPP_
 ...
 */
class SpinToAction : public BtActionNode<rc2024_interfaces::action::SpinTo>
{
public:
  /**
  ...
  static BT::PortsList providedPorts()
  {
    return providedBasicPorts(
      {
        BT::InputPort<double>("spin_direction", 0.0, "Spin direction"),
